...
export const EditableHeaderLabel: React.FC<EditableHeaderLabelProps> = ({
  ...
  onCancelEdit,
  onToggleVisibility,
  className = "sticky left-0 border border-gray-300 bg-gray-50 px-4 py-2 font-normal text-xs text-gray-500 uppercase tracking-wider z-[15] min-w-[200px] max-w-[33vw]"
}) => {
